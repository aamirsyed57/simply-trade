...
- **All implementation plans** must be saved in the `docs/` directory of the repository. This includes any `.md` files describing phase plans, design decisions, or technical roadmaps.
